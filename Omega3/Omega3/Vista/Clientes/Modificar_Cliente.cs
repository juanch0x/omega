...
namespace Omega3.Vista.Clientes
{
    public partial class Modificar_Cliente : Form
    {
        ...
        {
            Controlador.ControladorFuncVariadas.validarTextBoxVacios(txt_documento, txt_razon_social, txt_direccion, txt_telefono, txt_cod_postal, txt_contacto, txt_localidad, txt_mail_contacto);
            Controlador.ControladorFuncVariadas.validarEmail(txt_mail_contacto.Text);
            ...
            Controlador.ControlCliente.ModificarCliente(cliente);
